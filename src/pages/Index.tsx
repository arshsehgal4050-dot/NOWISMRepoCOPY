    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <span className="text-lg tracking-[0.3em] text-primary uppercase font-bold">Nowism</span>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center relative px-6 pt-20">
        <div className="absolute inset-0 bg-gradient-to-b from-primary/5 via-transparent to-transparent my-0" />
        <div className="relative z-10 flex flex-col items-center text-center max-w-3xl">
          ...
          />
          <h1 className="text-5xl md:text-7xl tracking-[0.2em] text-foreground mb-6 uppercase font-medium">
            Nowism
          </h1>
